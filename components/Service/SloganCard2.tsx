        ...
        <div data-cy="slogancard" className="flex flex-col lg:flex-row items-center">
            {title === "IT Consulting" || title === "Maintenance & Support" || title === "Application Development" ? (
                <div className="flex flex-row phone:flex-col-reverse phone:items-center phone:justify-center">
                    <Image src={imgSrc} alt="" className="icon1 w-[400px] phone:mt-[3%] tablet:mt-[0%] phone:w-[200px] phone: justify-center tablet:w-[200px]" />
                ...
                <div className="flex flex-row phone:flex-col-reverse phone:items-center phone:justify-center">
                    ...
                    <Image src={imgSrc} alt="" className="icon1 w-[350px] phone:mt-[3%] tablet:mt-[0%] phone:w-[200px] phone: justify-center tablet:w-[200px]" />
                </div>
            )}
        </div>
    );
